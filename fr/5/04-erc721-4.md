...
Oups ! Nous venons juste de rajouter une erreur dans notre code l’empêchant de compiler. Est-ce que vous l'avez vu ?
...
> Remarque : Nous utilisons aussi ce modificateur dans `zombiehelper.sol` et `zombieattack.sol`, mais nous ne voulons pas perdre trop de temps, alors nous avons modifier les noms dans ces fichiers pour vous.
