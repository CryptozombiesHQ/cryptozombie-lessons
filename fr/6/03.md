...
4. La première chose que `startApp()` doit faire est de déclarer une `var` appelée `cryptoZombiesAddress` égale à `"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d"` (c'est l'adresse du contrat sur le réseau principal).
