...
1. En dessous de `displayZombies`, copiez/collez le code à partir de `createRandomZombie` ci-dessus.
...
2. Nous allons implémenter une autre fonction : `feedOnKitty`.
  ...
  Faites une copie de `createRandomZombie` juste en dessous, avec les changements suivants :
