...
Como puedes ver, para usar herencia múltiple, sólo es necesario separar por comas `,` cada uno de los contratos múltiples. In this case, our contract is inheriting from `NickSzabo` and `HalFinney`.
