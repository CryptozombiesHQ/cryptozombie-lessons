...
3. Finally, there's an `Approval` event in the ERC721 spec. So we should fire this event at the end of this function. Check `erc721.sol` for the arguments, and be sure to use `msg.sender` as `_owner`.