  ...
  editor:
    ...
    startingCode:
      zombiefactory.sol: |
        ...
        import "./ownable.sol";
        // 1. Importa el archivo aqui

        contract ZombieFactory is Ownable {

          // 2. Declara utilizando safemath aqui
...
Para prevenir esto, OpenZeppelin ha creado una _**librería**_ llamada SafeMath que previene estos problemas por defecto.

Pero antes de entrar en eso... ¿Qué es una librería?

Una _**librería**_ es un tipo de contrato especial en Solidity. Una de las cosas para las cuales es útil, es para asociar funciones a tipos de datos nativos.
...
2. Añada la declaración `using SafeMath for uint256;`.
