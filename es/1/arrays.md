...
¿Recuerdas que las variables de estado quedan guardadas permanentemente en la cadena de bloques? Así que crear un array de estructuras así puede ser muy útil para guardar datos estructurados en tu contrato, como una base de datos.
...
Otros contratos podrían entonces leer pero no escribir en este array. Es un patrón de uso muy útil para guardar datos públicos en tu contrato.
