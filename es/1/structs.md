...
En nuestra aplicación, vamos a querer crear unos cuantos zombies. Y los zombis tienen varias propiedades, así que es un caso de uso perfecto para usar estructuras de datos `structs`

1. Crea una `struct` llamada `Zombie`.
