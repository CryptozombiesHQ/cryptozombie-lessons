...
4. Lo primero que debe hacer `startApp()` es declarar una `var` llamada `cryptoZombiesAddress` y asígnale su valor al string `"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d"` (esta es la dirección del contrato de CryptoZombies en la mainnet).
