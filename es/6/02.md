...
Recuerda, Ethereum esta compuesta de ***nodos*** los cuales comparten una copia de los mismos datos. Setting a Web3 Provider in Web3.js tells our code **which node** we should be talking to handle our reads and writes. Es como configurar la URL de un servidor remoto para tus llamadas API en una aplicación web tradicional.
