...
Los nodos de Ethereum sólo hablan un lenguaje llamado ***JSON-RPC***, el cual es muy difícil leer para un humano. A query to tell the node you want to call a function on a contract looks something like this:
