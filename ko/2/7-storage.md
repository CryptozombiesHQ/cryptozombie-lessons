...
***Storage***는 블록체인 상에 영구적으로 저장되는 변수를 의미하지. ***Memory***는 임시적으로 저장되는 변수로, 컨트랙트 함수에 대한 외부 호출들이 일어나는 사이에 지워지지. 두 변수는 각각 컴퓨터 하드 디스크와 RAM과 같지. 
...
하지만 이 키워드들을 사용해야 하는 때가 있지. 바로 함수 내의 ***구조체***와 ***배열***을 처리할 때지:
