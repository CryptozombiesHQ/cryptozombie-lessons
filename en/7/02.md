...
> Note: Some of these other files are quite large, so we're not including them in the lesson. You can access the full source on <a href="" target=_blank>this github repo</a>. But you don't need to worry about reading/understanding the contents of these files — we'll be explaining the relevant portions that you need to know in order to create your custom game mode.
