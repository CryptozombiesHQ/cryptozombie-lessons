...
material:
  editor:
    ...
    startingCode: |
        ...
        contract ZombieFactory /*1. inherit functionality of VRFConsumerBaseV2*/ {

            //2. Create all the new variables required by Chainlink VRF
