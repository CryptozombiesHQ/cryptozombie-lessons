...
4. The first thing `startApp()` should do is declare a `var` named `cryptoZombiesAddress` and set it equal to the string `"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d"` (this is the address of the CryptoZombies contract on mainnet).
