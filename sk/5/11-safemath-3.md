    ...
    startingCode:
      "zombiefactory.sol": |
        ...
        contract ZombieFactory is Ownable {
          ...
          // 1. Deklaruj using SafeMath32 for uint32
          // 2. Deklaruj  using SafeMath16 for uint16
          ...
          function _createZombie(string _name, uint _dna) internal {
            // Poznámka: Rozhodli sme sa že problém roku 2038 nechceme predísť... 
            // takže overflow readyTime nemusíš riešit. V roku 2038 aj tak prestane fungovať ;)
            uint id = zombies.push(Zombie(_name, _dna, 1, uint32(now + cooldownTime), 0, 0)) - 1;
            zombieToOwner[id] = msg.sender;
            // 3. Poďme použiť SafeMath tu
...
Teraz tieto knižnice potrebujeme použiť v ZombieFactory.

## Vyskúšaj si to sám

Zadanie:

1. Deklaruj, že pre `uint32` používame `SafeMath32`.
