...
Po tom čo nasadíš svoj kontrakt, dostaneš jeho adresu na Ethereum blockchaine, na ktorej zostane už navždy k dispozícii. Ak si spomínaš z Lekcie 2, adresa CryptoKitties kontraktu na hlavnej sieti Ethereum je `0x06012c8cf97BEaD5deAe237070F9587f8E7A266d`.
...
4. Prvá vec, ktorú by `startApp()` mala spraviť je deklarovať premennú `var cryptoZombiesAddress` a nastaviť jej hodnotu na `"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d"` (to je adresa CryptoZombies kontraktu na hlavnej Ethereum sieti, tzv. Ethereum MainNet).
