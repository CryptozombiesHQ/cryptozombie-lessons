...
Prvá vec ktorú budeme potrebovať je ***Web3 Provider***.

Nezabudni, že Ethereum sieť je vytvorená z ***uzlov***. Všetky uzly zdieľajú kópiu identických dát. Tým, že nakonfigurujeme naš Web3 Provider vo Web3.js mu povieme s ktorým **Ethereum uzlom** má komunikovať pre čítanie a zapisovanie dát na blockchain. Je to podobné, ako keď v kóde nastavíš URL serveru s ktorým má front end komunikovať v prípade tradičnej webovej aplikácie.

Ak chceš, môžeš si rozbiehať Ethereum uzol sám a použiť ho ako svojho providera. Život budeš mať ale jednoduchší ak použiješ niektorú z existujúcich služieb, ktorá sa o takéto Ethereum uzly stará. Takou službou je napríklad — ***Infura***.
...
Našťastie ani nemusíš. Existujú služby ktoré sa o tieto veci postarajú za teba. Jednou z najpopulárnejších možností je ***Metamask***.
