...
> Note: For convenience, we've stored Bob's address in an environment variable. Before you run the `bob.js` script, you'll have set it as follows: \`export BOB\_ADDRESS=\<BOB\_ACTUAL\_ADDRESS>
