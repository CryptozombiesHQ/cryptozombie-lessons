      ...
      "zombieownership.sol": |
        ...
        contract ZombieOwnership is ZombieAttack, ERC721 {
          ...
          function approve(address _approved, uint256 _tokenId) external payable onlyOwnerOf(_tokenId) {
            ...
            //Attiva l'evento di approvazione qui
          }
...
Fantastico, abbiamo quasi finito!

C'è ancora un'altra cosa da fare: c'è un evento `Approval` nelle specifiche ERC721. Quindi dovremmo lanciare questo evento al termine di questa funzione.

## Facciamo una prova

1. Lanciamo l'evento `Approval` al termine di questa funzione. Controlla `erc721.sol` per gli argomenti e assicurati di usare `msg.sender` come `_owner`.

Fantastico, abbiamo terminato la nostra implementazione ERC721!
