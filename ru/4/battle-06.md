...
3. Для определения исхода битвы используем случайное число от 0 до 99. Задай `uint` под названием `rand` и установи его равным результату функции `randMod` со `100` в качестве аргумента.
