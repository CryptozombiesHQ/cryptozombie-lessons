...
But in MultiversX, because the money (EGLD), the data (_transaction payload_), and the contract code itself are all live on MultiversX, it's possible for you to call a function **_and_** pay money to the contract at the same time.
