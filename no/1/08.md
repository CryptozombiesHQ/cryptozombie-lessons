...
material:
  terminal:
    prompt: "$"
    help: You should probably run `tbnbcli send --from testKey --to tbnb1111111111111111111111111111 --amount 100000000:BNB --chain-id=Binance-Chain-Nile --node=data-seed-pre-2-s1.binance.org:80 --memo "Spare my life!"`.
    commands:
      - 
        hint: tbnbcli send --from testKey --to tbnb1111111111111111111111111111 --amount 100000000:BNB --chain-id=Binance-Chain-Nile --node=data-seed-pre-2-s1.binance.org:80 --memo "Spare my life!"
        output: |
