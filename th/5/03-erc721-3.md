...
ยอดเยี่ยมมาก ๆ ต่อมาก็เข้าสู่ช่วงการโค้ด ERC721 กันแล้ว!
...
แต่ละฟังก์ชั่นจะต้องประกอบไปด้วยโค้ด 1 บรรทัดเท่านั้น ซึ่งก็คือ `return` statement ให้กลับไปดูโค้ดในบทก่อนหน้าว่าเราได้เก็บข้อมูลต่าง ๆ ไว้ที่ใดบ้าง หากนึกไม่ออกจริง ๆ ค่อยคลิกที่ "show me the answer" button สำหรับการช่วยเหลือก็ได้นะ
