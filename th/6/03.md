...
หลังจาก deploy ตัว contract ของเราไปแล้วก็จะได้รับ fixed address ที่จะอยู่บน Ethereum ไปตลอด ถ้าพวกเรายังจำเนื้อหาในบทเรียนที่ 2 ได้ จะนึกออกว่า address ของ CryptoKitties contract บน mainnet ของ Ethereum ก็คือ`0x06012c8cf97BEaD5deAe237070F9587f8E7A266d` นั่นเอง
...
4. method `startApp()` ควรประกาศค่า `var` ที่มีชื่อว่า `cryptoZombiesAddress` เป็นอันดับแรก และทำให้มันมีค่าเท่ากับข้อมูลชนิด string `"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d"` (นี่แหละคือ address ของ CryptoZombies contract บน mainnet)
