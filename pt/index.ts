...
import l6_ch3 from './6/03-talking-to-contracts.md'
import l6_ch4 from './6/04-calling-contract-functions.md'
import l6_ch5 from './6/05-metamask-accounts.md'
import l6_ch6 from './6/06-displaying-zombie-army.md'
import l6_ch7 from './6/07-sending-transactions.md'
import l6_ch8 from './6/08-calling-payable-functions.md'
import l6_ch9 from './6/09-subscribing-to-events.md'
