---
title: Padrão ERC721, Múltipla Herança
...
Já criamos `erc721.sol` com as interfaces acima para você.

1. Importe o `erc721.sol` em `zombieownership.sol`

2. Declare o `ZombieOwnership` herdando de `ZombieAttack` e `ERC721`
