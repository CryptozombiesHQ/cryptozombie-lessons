    ...
    startingCode:
      "zombiefeeding.sol": |
        ...
        contract ZombieFeeding is ZombieFactory {
          ...
          // 1. Mude o modificador para `onlyOwnerOf`
          ...
          // 2. Mude o nome do modificador aqui também
...
De volta em `zombiefeeding.sol`. Iremos mudar o nome do nosso `modifier` de `ownerOf` para `onlyOwnerOf`.

1. Mude o nome da definição do modificador para `onlyOwnerOf`

2. Role para baixo para a função `feedAndMultiply`, que usar este modificador. Precisamos mudar o nome aqui também.

> Nota: Nós também usamos este modificar em `zombiehelper.sol` e `zombieattack.sol`, mas não vamos gastar muito tempo nesta lição refatorando, então já saímos na frente e atualiza-mos os modificadores nos arquivos pra você.
